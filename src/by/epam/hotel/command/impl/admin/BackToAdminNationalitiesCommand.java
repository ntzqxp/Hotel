 ...
 * and is used to return admin back to page with operations on nationalities.
 * 
 * 
...
public class BackToAdminNationalitiesCommand implements ActionCommand{
	...
	public Router execute(HttpServletRequest request) throws CommandException {
		...
		if (sessionData.getRole() == RoleType.ADMIN) {
			page = ConfigurationManager.getProperty(PropertyConstant.PAGE_ADMIN_NATIONALITIES);
		} else {
